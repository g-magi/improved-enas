...
class MicroController(Controller):
	def __init__(self,
		...
		self.mov_avg_accuracy = tf.placeholder(tf.float32, shape=[None], name="mov_avg_accuracy")
	...
	def build_trainer(self, child_model):
		...
		self.scaled_acc, self.normal_arc_training, self.reduce_arc_training = scaler.tf_get_scaled_accuracy(
									self.normal_array,
									self.reduce_array,
									self.valid_acc,
