...
class MicroController(Controller):
	def __init__(self,
		...
		self.normal_array = tf.placeholder(tf.int32, shape=[None, 1],name="normal_array")
		self.reduce_array = tf.placeholder(tf.int32, shape=[None, 1],name="reduce_array")
	...
	def build_trainer(self, child_model):
		...
		if self.normal_array is not None:
			self.set_train_dicts = _set_train_dicts(self.normal_array, self.reduce_array)
